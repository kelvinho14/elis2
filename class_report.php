...
require('../../config.php');
require_once("class_report_form.php");
require_once("lib.php");
require_once("$CFG->dirroot/repository/lib.php");
            
$course_id = optional_param('id', 0, PARAM_INT);
$book_search_term 		= optional_param('book_search_term', '',PARAM_TEXT);
...
$PAGE->requires->js_init_call('block_elis2.elis2InitTab',array('report_div'));
...
$data->book_search_term = $book_search_term;
...
$mform = new elis2_class_report_form(null, array('data'=>$data, 'options'=>$options, 'config'=>$config));
