...
class elis2_class_report_form extends moodleform {
    function definition() {
		...
		for($i=0;$i<$report_size;$i++){
			$reporttypetab_html .= '<li><a href="#'.$report_arr[$i].'" onClick="document.getElementById(\'curr_type\').value=\''.$report_arr[$i].'\';block_elis2.elis2LoadReportData(\'\',\''.$report_arr[$i].'\')">'.$report_arr[$i].'</a></li>';
