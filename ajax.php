...
switch ($task) {
    ...
    case 'add_book_2_list':
		...
		list($total_book,$book_obj) = elis2_lib::get_books_from_service(array('id'=>$id),1,1);
    ...
    case 'delete_activity':
    	...
    	$output['return_html'] = in_array(false,$result)?get_string('failed_to_delete','block_elis2'):get_string('deleted','block_elis2');
    break;
